    ...
    function handlerPrepares(evName) {
        return function (e) {
            ...
            _prepares.forEach(function (c) {
                if (c.ignore || evName === "mouseleave" && c.ignore_leave || evName === "blur" && c.ignore_leave || evName === "mousemove" && (c.ignore_move || lastMouseY > c.min_y || speedY >= 0 || c.min_speed < speedY)) {
                    return;
                }

                c.func.call(c, new Cursor(lastMouseX, lastMouseY, speedX, speedY, dx, dy));
