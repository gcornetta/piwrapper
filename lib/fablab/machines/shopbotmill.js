   function ShopbotMill (path, config){
      ...
      this.dpi = config.dpi;
      this.isInches = (config.isInches === 'on')
      this.cutSpeed = parseFloat(config.cut_speed) / 25.4;
      this.plungeSpeed = parseFloat(config.plunge_speed) / 25.4;
      this.jogSpeed = parseFloat(config.jog_speed) / 25.4;
      this.jogHeight = parseFloat(config.jog_height) / 25.4 ;
      this.spindleSpeed = parseFloat(config.spindle_speed);

      console.log("isInches")
      console.log(this.isInches)
   }
