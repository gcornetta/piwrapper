...
var deviceDiscover = module.exports = function (name, url, type, vendor, threshold, sampleTime, hysteresis, dutyCycle, jobs) {
...
deviceDiscover.prototype.init = function (next) {
  ...
  setTimeout (function (next) {
    self.discover (device, self.name, self.url, self.type, self.vendor, self.threshold, self.sampleTime, self.hysteresis, self.interval, self.jobs)
  }, 1000)
  next ()
}
