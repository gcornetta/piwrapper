...
var deviceDiscover = module.exports = function (name, url, type, vendor, threshold, sampleTime, dutyCycle) {
...
deviceDiscover.prototype.init = function (next) {
  ...
  setTimeout (function (next) {
    self.discover (device, self.name, self.url, self.type, self.vendor, self.threshold, self.sampleTime, self.interval)
  }, 1000)
  next ()
}
