            ...
            case 'Milling machine':
              switch (machineVar.vendor) {
                ...
                case 'Shopbot':
                  ...
                  machineLib = require('../fablab/machines/shopbotmill')
                  break
              }
              break
          ...
          switch (machineVar.type) {
            ...
            case 'Milling machine':
                switch (machineVar.vendor){
                    ...
                    break
                    case 'Shopbot':
                        printFunctions.calculateAndSaveJobFile(that, printingJob, path, machineLib, machineVar)
                    break
                }
                break
            case '3D printer':
