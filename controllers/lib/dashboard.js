...
var dashboardPage = {
  ...
  sysInfoTable: {
    header: {col1: infoText.parameter, col2: infoText.value},
    rows: [
      {label: 'Architecture', translation: infoText.arch, value: null},
      ...
      {label: 'Average load',
        translation: infoText.avgLoad,
        value: [
        {label: infoText.timeWin1, value: null},
  ...
  wizardPage: {
    samplingDevices: [
        {vendor: 'Texas Instruments', deviceList: ['ADS 1015', 'ADS 1115']}
    ],
    machines: [
